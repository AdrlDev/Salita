...
import com.sprtcoding.salita.dashboard_activity.activity.assessment.adapter.ModerateAdapter
...
class ModerateMode : AppCompatActivity() {
    private lateinit var vpModerate: ViewPager
    private lateinit var btnNext: ImageButton
    private lateinit var btnPrev: ImageButton
    private lateinit var moderateAdapter: ModerateAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_moderate_mode)
    ...
    private fun initViews() {
        vpModerate = findViewById(R.id.vp_moderate)
    ...
    private fun init() {
        ...
        moderateAdapter = ModerateAdapter(this, assessmentViewModel,
            this,
        ...
        vpModerate.adapter = moderateAdapter
    }
    ...
    private fun afterInit() {
        ...
        vpModerate.addOnPageChangeListener(object : ViewPager.OnPageChangeListener {
            ...
            override fun onPageSelected(position: Int) {
                ...
                if (position == moderateAdapter.count - 1) {
        ...
        btnNext.setOnClickListener {
            val nextItem = vpModerate.currentItem + 1
            if (nextItem < moderateAdapter.count) {
                vpModerate.currentItem = nextItem
            } else {
                ...
                this.lifecycleScope.launch {
                    ...
                    if(score >= moderateAdapter.count - 2) {
                        val (dialog, btnOk) = Utils.congratsDialog(layoutInflater, this@ModerateMode, "Congrats",
                        ...
                        val (dialog, btnOk) = Utils.congratsDialog(layoutInflater, this@ModerateMode, "Oh Noo..",
        ...
        btnPrev.setOnClickListener {
            val prevItem = vpModerate.currentItem - 1
            if (prevItem >= 0) {
                vpModerate.currentItem = prevItem
            }
        }
    }

    private fun saveAssessment(score: Int, wrong: List<SelectedAnswerEntities>, dialog: AlertDialog) {
        val totalQ = moderateAdapter.count
