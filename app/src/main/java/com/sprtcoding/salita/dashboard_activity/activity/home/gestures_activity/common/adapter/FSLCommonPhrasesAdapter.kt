package com.sprtcoding.salita.dashboard_activity.activity.home.gestures_activity.common.adapter
...
class FSLCommonPhrasesAdapter(private val items: List<FSLItem>, private val context: Context) : RecyclerView.Adapter<FSLCommonPhrasesAdapter.ViewHolder>() {
