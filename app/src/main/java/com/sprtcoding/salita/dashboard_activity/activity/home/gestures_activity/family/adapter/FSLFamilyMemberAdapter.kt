package com.sprtcoding.salita.dashboard_activity.activity.home.gestures_activity.family.adapter
...
class FSLFamilyMemberAdapter(private val items: List<FSLItem>, private val context: Context) : RecyclerView.Adapter<FSLFamilyMemberAdapter.ViewHolder>() {
